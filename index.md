...
To reconstruct the amplitude ratio from the interferometer data, an $$\iota$$ representing a more face-on inspiral can pair with a positive $$\kappa$$,
or an $$\iota$$ representing a more face-off inspiral with a negative $$\kappa$$. As a result, many pairs of $$\iota$$ and $$\kappa$$ can be plausible with the frequency independence.
