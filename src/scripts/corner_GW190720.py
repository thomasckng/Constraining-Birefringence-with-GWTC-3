...
with h5py.File(paths.data/"IGWN-GWTC2p1-v2-GW190720_000836_PEDataRelease_mixed_nocosmo.h5", 'r') as f:
...
g.savefig(fname=paths.figures/"corner_GW190720.pdf", bbox_inches="tight", dpi=300)