...
with open(paths.output/"bimodal_events_mass.txt", "w") as f:
    f.write(r"\begin{tabular}{lcccc}Event & $M$ ($M_{\odot}$) & $\chi_p$ (GR) & $\chi_p$ (BR) & CL\\ \hline ")
    for event in ["GW170104", "GW190413_134308", "GW190521", "GW190805_211137", "GW191105_143521"]:
        ...
        chi_p_BR = result_DataFrame[result_DataFrame.event == event]['chi_p']
        chi_p_BR_median  = chi_p_BR.median()
        chi_p_BR_95 = chi_p_BR.quantile(0.95) - chi_p_BR_median
        chi_p_BR_5 = chi_p_BR_median - chi_p_BR.quantile(0.05)
        ...
        f.write(rf"{name} & ${mass_median:.1f}^{{+{mass_95:.1f}}}_{{-{mass_5:.1f}}}$ & ${chi_p_GR_median:.2f}^{{+{chi_p_GR_95:.2f}}}_{{-{chi_p_GR_5:.2f}}}$ & ${chi_p_BR_median:.2f}^{{+{chi_p_BR_95:.2f}}}_{{-{chi_p_BR_5:.2f}}}$ & ${credible_level:.3f}$")
