...
with open(paths.output/"bimodal_events_mass.txt", "w") as f:
    f.write(r"\begin{tabular}{lrrr}Event & Total Mass ($M_{\odot}$) & $\kappa$ & CL($\kappa=0$)\\ \hline ")
    for event in ["GW170104", "GW190413_134308", "GW190521", "GW190805_211137", "GW191105_143521"]:
        ...
        f.write(rf"{name} & ${mass_median:.1f}^{{+{mass_95:.1f}}}_{{-{mass_5:.1f}}}$ & ${kappa_median:.3f}^{{+{kappe_95:.3f}}}_{{-{kappe_5:.3f}}}$ & ${credible_level:.2f}$")
