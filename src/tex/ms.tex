...
% What's new?
In this study, we used a frequency-dependent birefringence model to constrain the strength of \ac{GW} amplitude birefringence by performing \ac{PE} on \ac{LVK} binaries.
...
\begin{figure*}
    ...
    \caption{
        The violin plot shows the posterior of $\kappa$ for 71 events in this study.
...
\begin{figure}[h]
    \script{birefringence_appendix.py}
    \includegraphics[width=\columnwidth]{figures/birefringence_appendix.pdf}
    \caption{The observed time domain signal with and without birefringence.}
    \label{fig:birefringence_appendix}
\end{figure}
...
\begin{figure}
    \script{corner_GW190720.py}
    \includegraphics[width=\columnwidth]{figures/corner_GW190720.pdf}
    \caption{Corner plot of GW190720.}
    \label{fig:corner_GW190720}
\end{figure}
