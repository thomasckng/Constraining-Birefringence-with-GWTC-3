...
Specifically, the interplay between birefringence and precession will manifest in the posterior of the precessing spin parameter $\chi_p$, defined as \cite{Schmidt:2014iyl}
\begin{equation}
...
We chart this and other degeneracies as part of the results we present in Sec.~\ref{sec:Results}.
...
The two effects can be balanced to yield the correct polarization ratio observed at the detector (predominantly left-handed, per the preference for $\cos\iota \approx -1$), as long as the distance is also enhanced to yield the right amount of birefringence and overall signal power.
...
The preference for $\kappa > 0$ over $\kappa < 0$ (and, therefore, the lack of bimodality in the $\cos\iota$ and $\kappa$ posteriors), is likely related to both the definite measurement of left-handed polarizations and of the phasing of the precession cycle.
...
Indeed, the inferred polarization angle in the birefringent case is notably different from the \ac{GR}.
We provide the full corner plot for all relevant parameters in Fig.~\ref{fig:corner_GW170818_appendix} in Appendix XX.
...
\begin{figure}
    ...
    \caption{
        GW170818 posterior on the precessing spin $\chi_p$, as obtained by allowing birefringence (blue) and not (orange). \mi{TODO (for Max): maybe make this an inset to Fig.~\ref{fig:corner_GW170818}.}
    }
