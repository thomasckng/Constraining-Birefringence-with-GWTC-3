...
As we anticipated in Sec.~\ref{sec:inclination}, this is driven by not having sufficient frequencies in band to disambiguate between $\kappa$ and $\cos\iota$.
As the most massive \ac{BBH} in our set, GW190521 is also the one with the fewest cycles in band, and therefore the most susceptible to this degeneracy.
...
\begin{figure}[h]
    ...
    \caption{
        GW190521 posterior on $\kappa$, luminosity distance $d_L$ and inclination $\cos\iota$ from our frequency-dependent (blue) and frequency-independent (orange) birefringence analysis, compared to the GR result (green).
