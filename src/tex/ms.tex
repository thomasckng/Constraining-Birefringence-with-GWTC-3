...
When considered individually, the events that best constrain $\kappa$ are listed in Table~\ref{tab:best_events}.
\begin{table}
    \begin{ruledtabular}
        \begin{tabular}{ll}
            Event & $\tilde{\kappa}$\\
            \hline
            \variable{output/best_events.txt}
        \end{tabular}
    \end{ruledtabular}
    \caption{
        Events that best constrain $\kappa$.
        $\tilde{\kappa}$ is the posterior median of $\kappa$.
    }
    \label{tab:best_events}
\end{table}
...
That is the case for GW170104, GW190413\_134308, GW190521, GW190805\_211137, and GW191105\_143521.
\begin{table}\
    \begin{ruledtabular}
        \begin{tabular}{ll}
            Event & Total Mass ($(M_{\odot})$)\\
            \hline
            \variable{output/bimodal_events_mass.txt}
        \end{tabular}
    \end{ruledtabular}
    \caption{
        Events that show bimodality in the $\kappa$ posterior.
        The total mass of the binary is given in solar masses.
    }
...
Figure \ref{fig:violin_kappa} shows some variance in the distribution of $\kappa$ posteriors, including some apparent outliers like GW170818.
