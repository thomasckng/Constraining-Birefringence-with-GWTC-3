...
\begin{figure}
    ...
    \caption{
        ...
        Note that the condition in Eq.~\eqref{eq:small_exponent} is not violated as the distance posterior shown here is the luminosity distance, not the comoving distance.
    }
