...
When considered in isolation, the first of these is the event with the most significant support for $\kappa \neq 0$; the second shows the sign of potential noise anomalies; and the third is representative of a class of events with strongly bimodal $\kappa$ posteriors.
...
Figure \ref{fig:corner_GW170818} shows the birefringence effect allows a region of $\kappa>0$ for a larger distance and smaller inclination angles than would be allowed in the absence of birefringence.
...
On the other hand, the birefringence effect will increase the amplitude ratio during propagation.
...
Other parameters such as the spins and polarization angles are notably different from the \ac{GR} case as well.
They may have some slight effect on the degeneracy, but they are not correlated with $\kappa$ significantly.
