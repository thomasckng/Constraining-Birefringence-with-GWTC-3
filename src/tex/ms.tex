...
Figure \ref{fig:corner_GW170818_appendix} shows the the regular \ac{GR} analysis (GR; orange) and the birefringent analysis (BR; blue), both of which show notable features.
...
Of the former, the two $\theta_{1/2}$ angles encode the tilts of the component \acp{BH} with respect to the orbital angular momentum, $\vec{L}$, while $\phi_{JL}$ is the angle between the projections of $\vec{L}$ and the total angular momentum, $\vec{J}$, along the orbital plane;
...
It is unusual for these angles to be well constrained, which suggests that data for this event display a particular phase and polarization signature.
