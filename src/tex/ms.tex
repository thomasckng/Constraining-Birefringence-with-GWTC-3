...
% What special treatment do we give to events
...
% mention excluded from all combined results
...
\end{figure*}
% show the excluded events visually different
...
% reweighted posterior of individual events in a single histogram
% create a session for all the outliers
...
% 0 is still in the 90%. there is much probability that kappa is not 0 due to degeneracy.
% Send Max the GW190521 full corner
...
% Comparison with the previous paper with the equation related to the parameter they used
