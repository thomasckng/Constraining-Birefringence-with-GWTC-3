...
The two events that show the largest tension with $\kappa = 0$ is GW170818, for which $|\mu_i / \sigma_i| =$ \variable{output/GW170818_constraint.txt}, and GW200129\_065458 (henceforth GW200129), for which $|\mu_i / \sigma_i| =$ \variable{output/GW200129_constraint.txt}.
